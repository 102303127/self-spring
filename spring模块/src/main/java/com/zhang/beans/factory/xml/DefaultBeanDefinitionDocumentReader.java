...
import com.zhang.context.annotation.ClassPathBeanDefinitionScanner;
...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
    ...
    @Override
    public void registerBeanDefinitions(Element root, BeanDefinitionRegistry registry) throws BeansException {
        ...
        if (componentScan != null) {
            ...
            // 实现了对component注解的解析，这里暂时不实现
            scanPackage(scanPath, registry);
        }
        ...
        for (Element bean : beanList) {
            ...
            for (Element property : propertyList) {
                ...
                if (StrUtil.isEmpty(propertyNameAttribute)) {
                    throw new BeansException("name 属性不能为 null 或为空");
                }
     ...
     * @param scanPath
     */
    private void scanPackage(String scanPath, BeanDefinitionRegistry registry) {
